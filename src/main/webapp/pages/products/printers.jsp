		...
		<table style="font:20px 'Times New Roman'" border="1" cellpadding="10" align="center" width="100%" height="200">
            ...
            <c:forEach items="${requestScope.productGroups}" var="productgroups">
                <tr>
                    ...
                    <td colspan="2"><c:out value="${productgroups.shortName}"/></td>
            ...
            <form action="/createProductGroup" method="post">
                <%--
                    <form>
                ...
                <tr>
                    <td colspan="2">
                        <input name='PGid' type="text" style="font:20px 'Times New Roman'">
