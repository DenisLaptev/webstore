...
<table style="width: 100%" class="style7">
    <tr>
        <td colspan="2" style="height: 70px" class="style8">
            <h1 class="style5">List of Product Group: Clothes</h1>
        </td>
    </tr>
    <tr>
        <td style="height: 541px" valign="top" class="style8">
		...
		<table style="font:20px 'Times New Roman'" border="1" cellpadding="10" align="center" width="100%" height="200">
            ...
            <tr>
                ...
                <td colspan="2" bgcolor="D0E92B">count</td>
                <td colspan="2" bgcolor="D0E92B">price</td>
            ...
            <c:forEach items="${requestScope.products}" var="products">
                <tr>
                    <td colspan="2">${products.id}</td>
                    <td colspan="2"><c:out value="${products.shortName}"/></td>
                    <td colspan="2"><c:out value="${products.description}"/></td>
                    <td colspan="2"><c:out value="${products.count}"/></td>
                    <td colspan="2"><c:out value="${products.price}"/></td>
                    <td colspan="2">
                        <a href="deleteProduct?id=${products.id}">delete product with
                            id=${products.id}</a>
                    </td>
                </tr>
            </c:forEach>
            ...
            <form action="/addProduct" method="post">
                ...
                <tr>
                    <td colspan="2">
                        <input name='Pid' type="text" style="font:20px 'Times New Roman'">
                    ...
                    <td colspan="2">
                        <input name='PshortName' type="text" style="font:20px 'Times New Roman'">
                    </td>
                    <td colspan="2">
                        <input name='Pdescription' type="text" style="font:20px 'Times New Roman'">
                    </td>
                    <td colspan="2">
                        <input name='Pcount' type="text" style="font:20px 'Times New Roman'">
                    </td>
                    <td colspan="2">
                        <input name='Pprice' type="text" style="font:20px 'Times New Roman'">
                    </td>
