...
<table style="width: 100%" class="style7">
    <tr>
        <td colspan="2" style="height: 70px" class="style8">
            <h1 class="style5">Failed Login Page</h1>
        </td>
    </tr>
    <tr>
		...
		<span class="style6">
            ...
            Please try again.
            <br/>
            <a href="/pages/login/loginpage.jsp">Back to the Login Page</a>
            <br/>
            or go to the <a href="/pages/registration/registration.jsp">registration form</a>
        </span>
        </td>
    </tr>
    <tr>
